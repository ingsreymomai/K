...
15. [HEADER-STYLE]: Instructions/Headers row: Bold, Not Centered, Text color matches font. (Background colors are strictly controlled by the SYSTEM, DO NOT inject them yourself).
16. [MCQ-FORMAT]: 
